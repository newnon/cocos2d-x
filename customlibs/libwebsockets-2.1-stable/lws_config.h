...
#define LWS_WITH_SSL 1
//#define LWS_WITH_SHARED 0
#define LWS_WITHOUT_TEST_SERVER 1
#define LWS_WITHOUT_TEST_SERVER_EXTPOLL 1
#define LWS_WITHOUT_TEST_PING 1
#define LWS_WITHOUT_TEST_ECHO 1
#define LWS_WITHOUT_TEST_CLIENT 1
#define LWS_WITHOUT_TEST_FRAGGLE 1
#define LWS_IPV6 1
...
#define LWS_INSTALL_DATADIR "/Users/vladimir/Development/cocos2d-x-3rd-party-libs-src-4/contrib/install-mac/x86_64/share"
...
/* The current git commit hash that we're building from */
#define LWS_BUILD_HASH "vladimir@Vladimirs-iMac.local-v3.4-176-gb843207"
