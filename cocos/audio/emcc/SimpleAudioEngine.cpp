...
SimpleAudioEngineEmcc * g_SimpleAudioEngineEmcc= nullptr; 


SimpleAudioEngine* SimpleAudioEngine::getInstance(){
  if(!g_SimpleAudioEngineEmcc){
    g_SimpleAudioEngineEmcc = new SimpleAudioEngineEmcc();
    g_SimpleAudioEngineEmcc->engine = new SimpleAudioEngine(); 
  }
  return g_SimpleAudioEngineEmcc->engine; 
};

  void SimpleAudioEngine::end(){
    if(g_SimpleAudioEngineEmcc){
      delete g_SimpleAudioEngineEmcc->engine; 
      delete g_SimpleAudioEngineEmcc;       
    }
    g_SimpleAudioEngineEmcc = nullptr; 
  };
  
  
    SimpleAudioEngine::SimpleAudioEngine(){
      g_SimpleAudioEngineEmcc->musicid = -1;
      g_SimpleAudioEngineEmcc->effectsvolume = 1.0f; 
    };
    ...
    void SimpleAudioEngine::preloadBackgroundMusic(const char* filePath){
      g_SimpleAudioEngineEmcc->musicpath = filePath; 
      AudioEngine::preload(filePath); 
    };
    
    void SimpleAudioEngine::playBackgroundMusic(const char* filePath, bool loop){
      g_SimpleAudioEngineEmcc->musicpath = filePath; 
      g_SimpleAudioEngineEmcc->musicid = AudioEngine::play2d(filePath, loop); 
    };

    void SimpleAudioEngine::stopBackgroundMusic(bool releaseData){
      AudioEngine::stop(g_SimpleAudioEngineEmcc->musicid);
      if(releaseData){
        AudioEngine::uncache(g_SimpleAudioEngineEmcc->musicpath.c_str()); 
      }
    };

    void SimpleAudioEngine::pauseBackgroundMusic(){
      AudioEngine::pause(g_SimpleAudioEngineEmcc->musicid); 
    };

    void SimpleAudioEngine::resumeBackgroundMusic(){
      AudioEngine::resume(g_SimpleAudioEngineEmcc->musicid);
    };

    void SimpleAudioEngine::rewindBackgroundMusic(){
      AudioEngine::setCurrentTime(g_SimpleAudioEngineEmcc->musicid, 0);
    };

    bool SimpleAudioEngine::willPlayBackgroundMusic(){
      return g_SimpleAudioEngineEmcc->musicid != -1; 
    };

    bool SimpleAudioEngine::isBackgroundMusicPlaying(){
        return AudioEngine::getState(g_SimpleAudioEngineEmcc->musicid) == AudioEngine::AudioState::PLAYING; 
    };
    ...
    float SimpleAudioEngine::getBackgroundMusicVolume(){
      return AudioEngine::getVolume(g_SimpleAudioEngineEmcc->musicid);
    };
    ...
    void SimpleAudioEngine::setBackgroundMusicVolume(float volume){
      AudioEngine::setVolume(g_SimpleAudioEngineEmcc->musicid, volume); 
    };
    ...
    float SimpleAudioEngine::getEffectsVolume(){
      return g_SimpleAudioEngineEmcc->effectsvolume;
    };
    ...
    void SimpleAudioEngine::setEffectsVolume(float volume){
      g_SimpleAudioEngineEmcc->effectsvolume = volume; 
    };
