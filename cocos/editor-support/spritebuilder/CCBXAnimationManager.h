...
public:
    ...
    void addNode(cocos2d::Node *pNode, const std::map<int, cocos2d::Map<std::string, CCBSequenceProperty*>>& seq);
...
private:
    ...
    std::map<cocos2d::Node*, std::map<int, cocos2d::Map<std::string, CCBSequenceProperty*>>> _nodeSequences;
    std::map<cocos2d::Node*, std::map<std::string, cocos2d::Value>> _baseValues;
    std::map<cocos2d::Node*, std::map<std::string, cocos2d::Ref*>> _objects;
