...
CCBXReaderSoundManager* CCBXReader::_soundEngine = nullptr;
...
void CCBXReader::setSoundManager(CCBXReaderSoundManager *manager)
{
    _soundEngine = manager;
}
    
CCBXReaderSoundManager* CCBXReader::getSoundManager()
{
    return _soundEngine;
}
